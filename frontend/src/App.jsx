...
const appRouter = createBrowserRouter([
  ...
  { path: '/ai/resume-parser', element: <ResumeParser /> },
  { path: '/ai/resume-analyzer', element: <ResumeAnalyzer /> },
  { path: '/ai/job-matcher', element: <JobMatcher /> },
  { path: '/ai/recommendations', element: <JobRecommendations /> },
  // Admin Routes
