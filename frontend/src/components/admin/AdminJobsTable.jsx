...
const AdminJobsTable = () => {
    ...
    return (
        <div style={{ overflowX: 'auto' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 140px auto', borderBottom: '1px solid var(--border-subtle)' }}>
                <div style={headerStyle}>Company</div>
                <div style={headerStyle}>Role</div>
                <div style={headerStyle}>Posted</div>
                <div style={{ ...headerStyle, textAlign: 'right' }}>Actions</div>
            </div>
