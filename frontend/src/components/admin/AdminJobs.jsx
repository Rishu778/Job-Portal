        ...
        <div style={{ minHeight: '100vh', background: 'var(--bg-primary)' }}>
            ...
            <div style={{ maxWidth: '1100px', margin: '0 auto', padding: containerPadding, position: 'relative', zIndex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
                    <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                            ...
                            <h1 style={{ fontFamily: 'Syne, sans-serif', fontWeight: '800', fontSize: headerFontSize, color: 'var(--text-primary)' }}>Posted Jobs</h1>
                        </div>
                ...
                <div style={{ position: 'relative', marginBottom: '24px', maxWidth: searchMaxWidth }}>
                    ...
                    <input placeholder="Filter by name or role..." onChange={e => setInput(e.target.value)} className="dark-input" style={{ paddingLeft: '42px', width: '100%', boxSizing: 'border-box' }} />
                </div>
