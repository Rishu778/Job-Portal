    ...
    return (
        <div onClick={() => navigate(`/description/${job._id}`)}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                    <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: '600', color: 'var(--text-primary)', fontSize: '14px' }}>{job?.company?.name}</div>
            ...
            <div>
                <h3 style={{ fontFamily: 'Syne, sans-serif', fontWeight: '700', fontSize: '16px', color: 'var(--text-primary)', marginBottom: '6px' }}>{job?.title}</h3>
